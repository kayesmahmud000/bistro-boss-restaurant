    ...
    return (
        <div>
            ...
            <div className='flex justify-between'>
              ...
              <button  className=' btn text-2xl font-bold bg-[#D1A054] text-white'>Pay</button>
               </Link>:<button disabled  className=' btn text-2xl font-bold bg-[#D1A054] text-white'>Pay</button> } 
            </div>
            <div>
